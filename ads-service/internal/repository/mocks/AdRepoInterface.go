...
// AdRepoInterface is an autogenerated mock type for the AdRepoInterface type
type AdRepoInterface struct {
	mock.Mock
}

// Create provides a mock function with given fields: ad
func (_m *AdRepoInterface) Create(ad *models.Ad) (int, error) {
	ret := _m.Called(ad)
...
func (_m *AdRepoInterface) GetAll(priceSort string, dateSort string, page int, userId int) ([]*models.Ad, error) {
...
func (_m *AdRepoInterface) GetOne(id int) (*models.Ad, error) {
	ret := _m.Called(id)
...
// NewAdRepoInterface creates a new instance of AdRepoInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewAdRepoInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *AdRepoInterface {
	mock := &AdRepoInterface{}
	mock.Mock.Test(t)
